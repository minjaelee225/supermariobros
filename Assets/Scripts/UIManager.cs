...
public class UIManager : MonoBehaviour {
	...
	List<Image> LoadingLivesDigit1 = new List<Image>();
    ...
    void Start()
    {
		...
		LoadingLives1 = GameObject.Find ("Loading_Lives1").GetComponent<Image> ();
        LoadingLivesDigit.Add(LoadingLives);
		LoadingLivesDigit1.Add(LoadingLives1);
		...
		SetDigits(LoadingLivesDigit1, playerLives);
